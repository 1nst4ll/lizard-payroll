...
<template>
    <AppLayout title="Add Manual Punch">
        <template #header>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <form @submit.prevent="submit">
                        <div class="mb-4">
                            ...
                            <select id="employee_id" v-model="form.employee_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
